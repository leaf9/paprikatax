// ---------------------------------------------------------------------------
// PaprikaTax landing page — all copy, links, and tuning knobs live here.
// Marketing can edit this file without touching components.
// ---------------------------------------------------------------------------
...
export const FOUNDER = {
  kicker: 'Why “Paprika”?',
  headline: 'Built by a CPA who watched his father miss the rules.',
  paragraphs: [
