...
export default function BeardTaxLanding() {
  ...
  usePageMeta(
    'See What Your Family Could Keep',
    'Hire your kids for real work, shift income to their 0% bracket, and carry the documentation to prove it. Free 60-second savings estimate.',
    { robots: 'noindex' }
  )
